...
pre_meta = MetaData()
post_meta = MetaData()
userDB = Table('userDB', pre_meta,
    Column('id', INTEGER, primary_key=True, nullable=False),
    Column('username', VARCHAR(length=25)),
    Column('password', VARCHAR(length=25)),
